...
public class HttpResponseAttributesHandler
extends HttpAttributesHandler<HttpResponseAttributes> {
    HttpResponseAttributesFactory factory;

    public HttpResponseAttributesHandler(HttpResponseAttributesFactory factory) {
        this.factory = factory;
    }

    @Override
    public Object addResponseHeaders(HttpResponseAttributes attributes, MultiMap<String, String> headers) {
        return this.factory.from(attributes, this.mergeHeaders((MultiMap<String, String>)attributes.getHeaders(), headers));
    }

    @Override
    public Object addRequestHeaders(HttpResponseAttributes attributes, MultiMap<String, String> headers) {
    ...
    @Override
    public Object removeHeaders(HttpResponseAttributes attributes, List<String> headerNames) {
